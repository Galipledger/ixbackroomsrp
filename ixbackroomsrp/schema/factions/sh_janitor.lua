FACTION.name = "Janitor"
FACTION.description = "Janitors are tasked with cleaning the facility and keeping it clean , can go on special cleaning tasks with guard escord"
